...
/* Does th eorder matter of properties when writing into the file because there are some properties like N which comes before BDAY and anniversary but when writing into file then get wriiten after anniversary and bday  */


/* Do we need to validate or write VERSION in the file. */
